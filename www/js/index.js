...
var app = {
    ...
    receivedEvent: function(id) {
        fastgoPushNotification.init("6uqRxlx5nZPFna8l5rxG8fcR");
...
// all future calls to require will path from that
// directory.
require([ './js/common.js'], function(common) {
    // Once we've ensured that common.js has loaded we can
